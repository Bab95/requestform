...
<html>
    ...
    <head>Student Registration Form
        <style type="text/css">
            ...
            .login-box .submit-box .sub-submit {
              position: relative;
            ...
            .login-box .submit-box .sub-submit:hover {
              background: #03e9f4;
              color: #fff;
              border-radius: 5px;
            ...
            .login-box .submit-box span {
              position: absolute;
              display: block;
            }

            .login-box .submit-box span:nth-child(1) {
              top: 0;
              left: -100%;
              width: 100%;
              height: 2px;
            ...
            .login-box .submit-form span:nth-child(2) {
              top: -100%;
              right: 0;
              width: 2px;
              height: 100%;
            ...
            .login-box .submit-form span:nth-child(3) {
              bottom: 0;
              right: -100%;
              width: 100%;
              height: 2px;
            ...
            .login-box .submit-form .sub-submit span:nth-child(4) {
              bottom: -100%;
              left: 0;
              width: 2px;
              height: 100%;
